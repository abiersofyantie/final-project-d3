                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-header mx-auto">
                      <h5 class="modal-title text-uppercase" id="createLabel">Input Data Kerentanan Lingkungan</h5>
                    ...
                    {{-- Form Create --}}
                    <form method="POST" action="{{ route('kerentanan-lingkungan.store') }}">
                      @csrf
                        ...
                        <div class="row">
                          <div class="col">
                            ...
                            <div class="form-group">
                              ...
                              <input type="number" name="lindung" class="form-control" id="input-lindung" step="1">
                            </div>
                            <div class="form-group">
                              <label class="form-control-label" for="input-alam">Hutan Alam</label>
                              <input type="number" name="alam" class="form-control" id="input-alam" step="1">
                            </div>
                          </div>
                          <div class="col">
                            <div class="form-group">
                              <label class="form-control-label" for="input-bakau">Hutan Bakau</label>
                              <input type="number" name="bakau" class="form-control" id="input-bakau" step="1">
                            </div>
                            <div class="form-group">
                              <label class="form-control-label" for="input-belukar">Semak Belukar</label>
                              <input type="number" name="belukar" class="form-control" id="input-belukar" step="1">
                            </div>
                          </div>
                        </div>
                      </div>
